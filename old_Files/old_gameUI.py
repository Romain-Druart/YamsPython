...
class ClientApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        frame = GamePage(parent=container, controller=self)
...
class GamePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.btnShuffleDices = tk.Button(self, text="Suffle Dices", command=self.shuffleDices); self.btnShuffleDices.grid(row = 14, column = 6)
        ...
        #Dice 1
        diceOne = (Image.open("./assets/dices/de1.png")).resize((100,100)); renderDiceOne = ImageTk.PhotoImage(diceOne); imgDiceOne = tk.Label(self, image=renderDiceOne)
        imgDiceOne.image = renderDiceOne; imgDiceOne.grid(row = 9, column = 4)
        #Dice 2
        diceTwo = (Image.open("./assets/dices/de2.png")).resize((100,100)); renderDiceTwo = ImageTk.PhotoImage(diceTwo); imgDiceTwo = tk.Label(self, image=renderDiceTwo)
        imgDiceTwo.image = renderDiceTwo; imgDiceTwo.grid(row = 9, column = 5)
        #Dice 3
        diceThree = (Image.open("./assets/dices/de3.png")).resize((100,100)); renderDiceThree = ImageTk.PhotoImage(diceThree); imgDiceThree = tk.Label(self, image=renderDiceThree)
        imgDiceThree.image = renderDiceThree; imgDiceThree.grid(row = 9, column = 6)
        #Dice 4
        diceFour = (Image.open("./assets/dices/de4.png")).resize((100,100)); renderDiceFour = ImageTk.PhotoImage(diceFour); imgDiceFour = tk.Label(self, image=renderDiceFour)
        imgDiceFour.image = renderDiceFour; imgDiceFour.grid(row = 9, column = 7)
        #Dice 5
        diceFive = (Image.open("./assets/dices/de5.png")).resize((100,100)); renderDiceFive = ImageTk.PhotoImage(diceFive); imgDiceFive = tk.Label(self, image=renderDiceFive)
        imgDiceFive.image = renderDiceFive; imgDiceFive.grid(row = 9, column = 8)
    ...
    def validateDices(self): #add data to json file and display changes
        ...
        self.btnShuffleDices.config(state="enable")
        self.numberOfToss = 0
        return comboBoxSelectedValue

    def shuffleDices(self): #shuffle dices, send data to json to display dices for oppennent
